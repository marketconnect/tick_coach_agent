...
export PROXY_USER
export PROXY_PASS
export TICK_COACH_YDB_ENDPOINT
export TICK_COACH_YDB_DATABASE
...
ENV_ARGS = "TELEGRAM_BOT_TOKEN=$$TELEGRAM_BOT_TOKEN,TELEGRAM_CHAT_ID=$$TELEGRAM_CHAT_ID,LANGSMITH_TRACING=$$LANGSMITH_TRACING,LANGSMITH_PROJECT=$$LANGSMITH_PROJECT,YDB_ENDPOINT=$$TICK_COACH_YDB_ENDPOINT,YDB_DATABASE=$$TICK_COACH_YDB_DATABASE,OPENROUTER_API_KEY=$$OPENROUTER_API_KEY,GROQ_API_KEY=$$GROQ_API_KEY,AGENTROUTER_API_KEY=$$AGENTROUTER_API_KEY,LANGSMITH_API_KEY=$$LANGSMITH_API_KEY,OPENROUTER_BASE_URL=$$OPENROUTER_BASE_URL,GROQ_BASE_URL=$$GROQ_BASE_URL,AGENTROUTER_BASE_URL=$$AGENTROUTER_BASE_URL,PROXY_HOST=$$PROXY_HOST,PROXY_PORT=$$PROXY_PORT,PROXY_USER=$$PROXY_USER,PROXY_PASS=$$PROXY_PASS,PROXY_URL=$$PROXY_URL"
